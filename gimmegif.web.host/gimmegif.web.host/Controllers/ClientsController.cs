...
namespace gimmegif.web.host.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Instagram")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Instagram")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
