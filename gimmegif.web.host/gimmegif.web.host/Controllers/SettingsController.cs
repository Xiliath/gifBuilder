...
namespace gimmegif.web.host.Controllers
{
    public class SettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InstaTags")] Settings settings)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InstaTags")] Settings settings)
        {
            if (id != settings.Id)
            {
                return NotFound();
